...
<html lang="en">
   <head>
      ...
      <!-- Responsive-->
      <link rel="stylesheet" href="{{asset('lighten/css/responsive.css')}}">
      <!-- fevicon -->
      <link rel="icon" href="lighten/images/fevicon.png" type="image/gif" />
   ...
   <body class="main-layout">
      @include('layouts.lighten.zones.nav')
      @yield('contenido')
      @include('layouts.lighten.zones.contact')
      @include('layouts.lighten.zones.footer')
      <!-- Javascript files--> 
